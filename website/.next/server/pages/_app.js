...
// EXTERNAL MODULE: ./src/store/api/adminService.ts
var adminService = __webpack_require__(8320);
// EXTERNAL MODULE: ./src/store/slices/adminSlice.ts
var adminSlice = __webpack_require__(241);
...
const store = (0,toolkit_.configureStore)({
    reducer: {
        ...
        admin: adminSlice/* default.reducer */.ZP.reducer,
        [adminService/* default.reducerPath */.Z.reducerPath]: adminService/* default.reducer */.Z.reducer
    },
    middleware: (getDefaultMiddleware)=>getDefaultMiddleware().concat(adminService/* default.middleware */.Z.middleware)
});
...
var __webpack_exports__ = __webpack_require__.X(0, [993,916], () => (__webpack_exec__(5265)));
